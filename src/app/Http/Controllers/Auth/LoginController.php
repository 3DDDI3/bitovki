...
class LoginController extends Controller
{
    ...
    */
     ...
     * @var string
     */
    protected $redirectTo = 'admin/services/settings';
    ...
    public function login_code(Request $request)
    {
        ...
        switch ($method) {
            case 'code_check':
                return self::code_check($request);
                break;
            case 'code_phone':
                return self::code_save($request, 'phone');
                break;
            case 'code_email':
                return self::code_save($request, 'email');
                break;
        }
        return;
    }
