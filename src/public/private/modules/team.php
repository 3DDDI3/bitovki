...
if (isset($_GET['add']) || isset($_GET['edit'])):
    ...
    <div class='admin_edit_block'>
        ...
        <form action='/<?= URI ?>' method='post' class='admin_edit-form' enctype='multipart/form-data'>
            ...
            <?= GenerateForm::makeTextarea('Имя', 'name', $object->name) ?>
            <?= GenerateForm::makeTextarea('Профессия', 'title', $object->title) ?>
...
<?php elseif (isset($_POST['add']) || isset($_POST['edit'])):
    ...
    FileUpload::uploadImage('image', get_class($object), 'image', $object->id, 480, null, $path);
