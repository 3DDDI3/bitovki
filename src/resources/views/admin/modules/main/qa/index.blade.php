...
@section('content')
    ...
    @include('admin.includes.search', ['search_label' => 'Введите вопрос'])
    ...
    @if ($objects)
        ...
        <div class="sortable_list">
            ...
            color: #ffffff">
                <p style="flex-basis: 40%;">Вопрос</p>
                <p style="flex-basis: 40%;">Ответ</p>
            ...
            @foreach ($objects as $object)
                <div class="list_item">
                    ...
                    <div style="flex-basis: 40%">{{ $object->answer }}</div>
